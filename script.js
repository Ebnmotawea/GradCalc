    function handleLogoDisplay() {
        const logoImage = document.getElementById('homeImage'); // Replace 'homeImage' with your logo's ID
        if (logoImage) {
            const isHomePage = document.getElementById('start').style.display !== 'none'; // Check if the home page is visible
            if (isHomePage) {
                logoImage.style.display = 'block'; // Show the logo on the home page
            } else {
                logoImage.style.display = 'none'; // Hide the logo on other pages
            }
        } else {
  ...
  function showHomeImage() {
      ...
      if (homeImage) {
          console.log("Showing home image.");
          homeImage.removeAttribute('hidden');
      } else {
          console.error("homeImage not found!");
      }
  }
  ...
  function hideHomeImage() {
      const homeImage = document.getElementById('homeImage');
      if (homeImage) {
          console.log("Hiding home image.");
          homeImage.setAttribute('hidden', 'true');
      } else {
          console.error("homeImage not found!");
      }
  }
